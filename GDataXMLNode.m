...
-(GDataXMLNode *)createChildNodeWithName:(NSString *)name {
	GDataXMLNode *child = [GDataXMLNode elementWithName:name];
	[self addChild:child];
	return child;
}

-(GDataXMLNode *)createChildNodeWithName:(NSString *)name stringValue:(NSString *)value {
	GDataXMLNode *child = [GDataXMLNode elementWithName:name stringValue:value];
	[self addChild:child];
	return child;
}

-(GDataXMLElement *)createChildElementWithName:(NSString *)name {
	GDataXMLElement *child = [GDataXMLElement elementWithName:name];
	[self addChild:child];
	return child;
}

-(GDataXMLElement *)createChildElementWithName:(NSString *)name stringValue:(NSString *)value {
	GDataXMLElement *child = [GDataXMLElement elementWithName:name stringValue:value];
	[self addChild:child];
	return child;
}
